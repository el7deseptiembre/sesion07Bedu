###################### SESION 5: SERIES DE TIEMPO #######################
################################################################################
## EJEMPLO 1: CONEXION ENTRE RSTUDIO Y GITHUB


################################################################################
## EJEMPLO 2: CONEXION A UNA BDD CON R
...
pop.mean <- mean(DataDB$Population)  # Media a la variable de poblacion
pop.mean 
...
# Se realiza la lectura de la BDD con el comando dbPool, los demas parametros 
...
str(JsonData)                       # Vemos la naturaleza de sus atributos
